...
map("n", "<C-Left>", "<cmd>SmartCursorMoveLeft<CR>", { desc = "Move to the left pane", silent = true })
map("n", "<C-Right>", "<cmd>SmartCursorMoveRight<CR>", { desc = "Move to the right pane", silent = true })
map("n", "<C-Up>", "<cmd>SmartCursorMoveUp<CR>", { desc = "Move to the up pane", silent = true })
map("n", "<C-Down>", "<cmd>SmartCursorMoveDown<CR>", { desc = "Move to the down pane", silent = true })
