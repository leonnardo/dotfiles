...
map("n", "<leader>ww", "<cmd>w<cr>", { desc = "Save current buffer", silent = true })
...
map("n", "<leader>rs", "<cmd>source %<CR>", { desc = "Source config", silent = true })
map("n", "<leader>rr", "<cmd>.lua<CR>", { desc = "Execute current line", silent = true })
map("v", "<leader>rr", "<cmd>'<,'>lua<CR>", { desc = "Execute selected lines", silent = true })
